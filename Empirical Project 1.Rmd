...
graph1 <- boston %>%
  filter(tract %in% c(071101,070500,070800)) %>%
  ...
  labs(x="Tract", 
       ...
       title = "Average Income for White Children")
...
graph2 <- boston %>%
  ...
  labs(x="Tract", 
       y= "Average Income Percentile",
       title= "Average Income for Black Children")
...
boston %>%
  ...
  labs(x= "Average Income",
       ...
       subtitle= "Average Income in Boston is 76683.59 dollars")
